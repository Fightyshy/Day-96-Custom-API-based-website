...
class Servers:
    ...
    def get_jp(self) -> list:
        server = []
        with open(
            r"application/static/assets/constants/server_region_JP.csv"
        ) as jpservers:
    ...
    def get_NA(self) -> list:
        server = []
        with open(
            r"application/static/assets/constants/server_region_NA.csv"
        ) as jpservers:
            file = csv.DictReader(jpservers)
            for row in file:
                server.append(
    ...
    def get_EU(self) -> list:
        server = []
        with open(
            r"application/static/assets/constants/server_region_EU.csv"
        ) as jpservers:
            file = csv.DictReader(jpservers)
            for row in file:
                server.append(
    ...
    def get_OC(self) -> list:
        server = []
        with open(
            r"application/static/assets/constants/server_region_OC.csv"
        ) as jpservers:
            file = csv.DictReader(jpservers)
            for row in file:
                server.append(
...
class Raidzones:
    ...
    def get_zones(self):
        with open(r"application/static/assets/constants/raidzone_ids.csv") as raidzones:
            zones = [
                {
                    "tier": zone["tier"],
                    "expac": zone["expac"],
...
class MetaLinks:
    ...
    def get_meta_links(self):
        with open(
            r"application/static/assets/lodestone-css-selectors-main/meta.json"
        ) as meta:
...
class CharacterData:
    ...
    def get_character_selectors(self):
        with open(
            r"application/static/assets/lodestone-css-selectors-main/profile/character.json"
        ) as chardata:
            return json.load(chardata)

    def get_classjob_selectors(self):
        with open(
            r"application/static/assets/lodestone-css-selectors-main/profile/classjob.json"
        ) as chardata:
            return json.load(chardata)

    def get_classjob_abbreviation(self):
        with open(
            r"application/static/assets/constants/class_abbreviation.csv"
        ) as abbreviations:
            file = csv.DictReader(abbreviations)
            return {key["full"]: key["abbr"] for key in file}

    def get_classjob_role(sefl):
        with open(r"application/static/assets/constants/class_abbreviation.csv") as roles:
            file = csv.DictReader(roles)
            return {key["full"]: key["role"] for key in file}

    def get_minions(self):
        with open(
            r"application/static/assets/lodestone-css-selectors-main/profile/minion.json"
        ) as minion:
            return json.load(minion)

    def get_mounts(self):
        with open(
            r"application/static/assets/lodestone-css-selectors-main/profile/mount.json"
        ) as mount:
            return json.load(mount)

    def get_freecompany(self):
        with open(
            r"application/static/assets/lodestone-css-selectors-main/freecompany/freecompany.json"
        ) as freecompany:
            return json.load(freecompany)

    def get_achievements(self):
        with open(
            r"application/static/assets/lodestone-css-selectors-main/profile/achievements.json", encoding="utf8"
        ) as achievement:
